...
const getVapidKey = async (csrfToken) => {
  try {
    ...
    throw new Error(
      'Clave VAPID pública no encontrada en la respuesta del servidor.'
    );
  } catch (error) {
...
export const subscribeUserToPush = async (userId, csrfToken) => {
  ...
  if (permission !== 'granted') {
    console.warn(
      '⛔ Suscripción abortada: Permiso de notificación denegado o cerrado.'
    );
    return;
  }
