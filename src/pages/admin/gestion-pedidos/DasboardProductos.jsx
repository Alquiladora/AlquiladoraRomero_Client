...
import {
  faChair, faChartBar, faChartPie, faChartLine, faUser
  ...
  const {
    ...
    orders.forEach(p => {
      ...
      mapTipoCliente[p.cliente.tipoCliente] =
        (mapTipoCliente[p.cliente.tipoCliente] || 0) + Number(p.pago.total || 0);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
          <h2 className="text-xl font-semibold mb-6 flex items-center">
            <FontAwesomeIcon icon={faChartBar} className="mr-2 text-yellow-500" />
            Top Productos por Ingresos
          </h2>
          <Chart
            {...chartCommon}
            options={{
              ...chartCommon,
              xaxis: { categories: productosIngresos.map(p => p.nombre), ...chartCommon.xaxis },
              title: { text: "Ingresos por Producto", ...chartCommon.title },
            }}
            series={[{ name: "Ingresos", data: productosIngresos.map(p => p.ingreso) }]}
            type="bar"
            height={340}
          />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
          ...
          <Chart
            ...
            options={{
              ...chartCommon,
              xaxis: { categories: productosCantidades.map(p => p.nombre), ...chartCommon.xaxis },
              title: { text: "Cantidad por Producto", ...chartCommon.title },
            }}
            series={[{ name: "Cantidad", data: productosCantidades.map(p => p.cantidad) }]}
            type="bar"
            height={340}
          />
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl lg:col-span-2">
          <h2 className="text-xl font-semibold mb-6 flex items-center">
            <FontAwesomeIcon icon={faChartLine} className="mr-2 text-yellow-500" />
            Tendencia Mensual de Ingresos por Producto
          </h2>
          <Chart
            {...chartCommon}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
          <h2 className="text-xl font-semibold mb-6 flex items-center">
            <FontAwesomeIcon icon={faChartPie} className="mr-2 text-yellow-500" />
          ...
          <Chart
            ...
            options={{
              ...
              title: { text: "Porcentaje de Ingresos por Producto", ...chartCommon.title },
            }}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl">
          ...
          <Chart
            ...
            options={{
              ...
              legend: { position: "bottom" },
              title: { text: "Distribución de Ingresos por Tipo de Cliente", ...chartCommon.title },
            }}
