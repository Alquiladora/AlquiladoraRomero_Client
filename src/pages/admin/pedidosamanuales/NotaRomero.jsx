            ...
            >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                    ...
                    <div style={{ textAlign: 'right', fontSize: '11px' }}>
                        ...
                        <div style={{ color: 'red' }}><strong>N° {datos.pedido}</strong></div>
                    </div>
                </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '16px' }}>
                    ...
                    <tbody>
                        {datos.productos.map((p, i) => (
                            <tr key={i}>
                                <td style={{ border: '1px solid black', padding: '4px' }}>{p.cantidad}</td>
                                <td style={{ border: '1px solid black', padding: '4px' }}>{p.descripcion}</td>
                                <td style={{ border: '1px solid black', padding: '4px' }}>${p.precio}</td>
                                <td style={{ border: '1px solid black', padding: '4px' }}>${p.importe}</td>
                            </tr>
                        ))}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                    ...
                    <table style={{ borderCollapse: 'collapse', height: '76px' }}>
                        <tbody>
                            <tr><td style={{ border: '1px solid black', padding: '4px' }}><strong>Total</strong></td><td style={{ border: '1px solid black', padding: '4px' }}>${datos.total}</td></tr>
                            <tr><td style={{ border: '1px solid black', padding: '4px' }}><strong>Anticipo</strong></td><td style={{ border: '1px solid black', padding: '4px' }}>${datos.anticipo}</td></tr>
                            <tr><td style={{ border: '1px solid black', padding: '4px' }}><strong>Resta</strong></td><td style={{ border: '1px solid black', padding: '4px' }}>${datos.resta}</td></tr>
                        </tbody>
                    </table>
                </div>
