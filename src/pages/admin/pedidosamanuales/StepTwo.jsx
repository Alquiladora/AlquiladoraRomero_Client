            ...
            >
              ...
              <div className="text-sm text-gray-600 ml-6 space-y-1">
                ...
                <p className="flex items-center">
                  <FontAwesomeIcon icon={faClipboard} className="text-gray-500 mr-2" />
                ...
                <p className="flex items-center">
                  <FontAwesomeIcon icon={faMapPin} className="text-gray-500 mr-2" />
        ...
        <>
          ...
          <div className="flex items-end space-x-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded ${codigoPostal.length === 5 && !cargandoCP
