...
function ProductTable() {
  ...
  const fetchSubcategorias = async () => {
    try {
      ...
      console.log("Subcategorias ", response.data.subcategories);
    } catch (error) {
      ...
      const response = await apiImagen.post(
        ...
        formData,
        {
          ...
          onUploadProgress: (progressEvent) => {
            ...
            console.log("Progreso de l asubida de la imagen", percent);
          },
        }
      );
  ...
  const handleSave = async () => {
    ...
    console.log("Imagenes total", totalImagesCount);

    const allErrors = validateProduct(selectedProduct, totalImagesCount);
    console.log("Imagenes total", allErrors);
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center w-full md:w-1/3">
            <select
              className="border px-4 py-2 rounded-lg focus:ring-2 
