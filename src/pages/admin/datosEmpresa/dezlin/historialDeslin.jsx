...
const HistorialDeslindeLegal = ({ onNavigate }) => {
  ...
  const fetchDocumentos = async () => {
    try {
      ...
      console.error('Error al obtener los deslindes:', err);
      setError('No se pudieron cargar los deslindes.');
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        Historial de Deslinde de Responsabilidad
      </Typography>
        ...
        <Table className="min-w-full">
          <TableHead>
            <TableRow className="bg-yellow-100 dark:bg-gray-700">
              <TableCell className="text-gray-800 dark:text-gray-100 font-semibold">
                Título
              </TableCell>
              <TableCell className="text-gray-800 dark:text-gray-100 font-semibold">
                Versión
          ...
          <TableBody>
            {paginatedDeslindes.map((deslinde) => (
              ...
              >
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(deslinde.fechaVigencia)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <Typography
                    variant="body2"
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(deslinde.created_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(deslinde.updated_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <IconButton
                    onClick={() => handleOpenModal(deslinde)}
                    color="primary"
                    aria-label={`Ver detalles del deslinde ${deslinde.titulo}`}
                    className="dark:text-gray-100"
                  >
                    <Visibility />
                  </IconButton>
      ...
      <Dialog
        ...
        fullWidth
        maxWidth="md"
        aria-labelledby="detalles-deslinde-title"
      ...
      >
        ...
        <DialogContent
          dividers
          className="bg-white dark:bg-gray-900 transition-colors duration-300 p-4"
        >
          {selectedDeslinde ? (
            <Box className="space-y-6">
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedDeslinde.fechaVigencia)}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography
                  ...
                  <Chip
                    label={
                      selectedDeslinde.estado.charAt(0).toUpperCase() +
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedDeslinde.created_at)}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedDeslinde.updated_at)}
                  </Typography>
                </Grid>
              </Grid>
              ...
              <Box>
                ...
                {selectedDeslinde.secciones &&
                selectedDeslinde.secciones.length > 0 ? (
                  <List className="space-y-3">
                    {selectedDeslinde.secciones.map((seccion, index) => (
                      <ListItem
                        key={index}
