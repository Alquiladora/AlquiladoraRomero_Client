          ...
          <TableBody>
            {paginatedPoliticas.map((politica) => (
              ...
              >
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(politica.fechaVigencia)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <Typography
                    variant="body2"
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(politica.created_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(politica.updated_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <IconButton
          ...
          {selectedPolitica ? (
            <Box className="space-y-6">
              ...
              <Box>
                ...
                {selectedPolitica.secciones &&
                selectedPolitica.secciones.length > 0 ? (
