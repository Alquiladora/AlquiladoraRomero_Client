...
const HistorialTerminos = ({ onNavigate }) => {
  ...
  const handleCloseModal = ({ onNavigate }) => {
  ...
  return (
    ...
    >
          ...
          <TableBody>
            {paginatedTerminos.map((termino) => (
              ...
              >
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(termino.fechaVigencia)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <Typography
                    variant="body2"
                ...
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(termino.created_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  {formatDate(termino.updated_at)}
                </TableCell>
                <TableCell className="text-gray-800 dark:text-gray-100">
                  <IconButton
                    onClick={() => handleOpenModal(termino)}
                    color="primary"
                    aria-label={`Ver detalles del término ${termino.titulo}`}
                    className="dark:text-gray-100"
                  >
                    <Visibility />
                  </IconButton>
      ...
      <Dialog
        ...
        fullWidth
        maxWidth="md"
        aria-labelledby="detalles-termino-title"
          ...
          {selectedTermino ? (
            <Box className="space-y-6">
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedTermino.fechaVigencia)}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography
                  ...
                  <Chip
                    label={
                      selectedTermino.estado.charAt(0).toUpperCase() +
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedTermino.created_at)}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography
                  ...
                  <Typography
                    ...
                    className="text-gray-800 dark:text-gray-100"
                  >
                    {formatDate(selectedTermino.updated_at)}
                  </Typography>
                </Grid>
              </Grid>
              ...
              <Box>
                ...
                {selectedTermino.secciones &&
                selectedTermino.secciones.length > 0 ? (
                  <List className="space-y-3">
                    {selectedTermino.secciones.map((seccion, index) => (
                      <ListItem
                        key={index}
