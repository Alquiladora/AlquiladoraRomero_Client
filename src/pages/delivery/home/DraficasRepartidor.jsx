...
const Dashboard = ({ estadisticas }) => {
  ...
  const pieData = [
    {
      name: 'Recogiendo',
      value: safeEstadisticas.totalRecogiendo || 0,
      color: '#3B82F6',
    },
    {
      name: 'En Alquiler',
      value: safeEstadisticas.totalEnAlquiler || 0,
      color: '#F59E0B',
    },
    {
      name: 'Enviando',
      value: safeEstadisticas.totalEnviando || 0,
      color: '#EF4444',
    },
    {
      name: 'Finalizado',
      value: safeEstadisticas.totalFinalizado || 0,
      color: '#10B981',
    },
  ];
  ...
  const radialData =
    Array.isArray(safeEstadisticas.pedidosFinalizadosPorMes) &&
    safeEstadisticas.pedidosFinalizadosPorMes.length > 0
  ...
  const valoracionData = [
    {
      name: 'Puntuación',
      value: parseFloat(safeEstadisticas.promedioValoracion) || 0,
      fill: '#10B981',
    },
  ];
  ...
  const hasDataForCharts =
    ...
    radialData.some((item) => item.value > 0) ||
    parseFloat(safeEstadisticas.promedioValoracion) > 0;
      ...
      <section className="max-w-7xl mx-auto p-6 md:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            {
              label: 'Recogiendo',
              value: safeEstadisticas.totalRecogiendo,
              icon: Clock,
              color:
            ...
            {
              label: 'En Alquiler',
              value: safeEstadisticas.totalEnAlquiler,
              icon: Package,
              color:
            ...
            {
              label: 'Enviando',
              value: safeEstadisticas.totalEnviando,
              icon: Truck,
              color:
            ...
            {
              label: 'Finalizado',
              value: safeEstadisticas.totalFinalizado,
              icon: CheckCircle,
              color:
            ...
            >
              <div className="flex flex-col items-center">
                <div
                  className={`w-14 h-14 ${item.color} rounded-full flex items-center justify-center mb-4`}
                >
        ...
        {!hasDataForCharts ? (
          <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 dark:bg-gray-800 dark:border-gray-700 text-center">
            <p className="text-gray-500 dark:text-gray-400 text-base md:text-lg">
              No hay datos disponibles para mostrar los gráficos. Por favor,
              registra actividad para generar estadísticas.
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 dark:bg-gray-800 dark:border-gray-700">
              ...
              {safeEstadisticas.promedioValoracion > 0 ? (
                ...
                <p className="text-center text-gray-500 dark:text-gray-400 text-base md:text-lg">
