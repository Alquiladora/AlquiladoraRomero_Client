  ...
  useEffect(() => {
    const validatePasswords = async () => {
      ...
      // Validación de complejidad
        ...
        validationError = "La contraseña debe contener al menos una letra minúscula.";
        isValid = false;
      } else if (!/(?=.*[A-Z])/.test(newPassword)) {
        validationError = "La contraseña debe contener al menos una letra mayúscula.";
        isValid = false;
  ...
  return (
    <div className="max-w-[500px] mx-auto my-20 p-8 bg-white dark:bg-gray-900 shadow-lg rounded-lg relative border-t-4 border-t-yellow-400 min-h-[300px]">
      ...
      >
        ...
        {["Muy débil", "Débil", "Aceptable", "Fuerte", "Muy fuerte"][passwordStrengthScore]}
      </p>
