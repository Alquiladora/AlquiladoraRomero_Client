...
export const useSocket = () => {
  ...
  useEffect(() => {
    ...
    socketIo.on("connect", () => {
      console.log(`✅ Socket conectado con ID: ${socketIo.id} en URL: ${SOCKET_SERVER_URL}`);
    ...
    socketIo.on("connect_error", (err) => {
      ...
      console.error(`❌ Error de conexión al socket en ${SOCKET_SERVER_URL}:`, err.message, err.description);
