    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          'Error al rastrear el pedido. Intenta de nuevo más tarde.'
      );
    ...
    <div className="min-h-screen to-gray-200 dark:from-gray-800 dark:to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {!order && (
          ...
          >
            <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
              Ingresa tu ID de rastreo para seguir el estado de tu pedido en
              tiempo real.
            </p>
            <form
                ...
                {showNotification && order.status === 'Incompleto' && (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-900 dark:text-gray-100">
                      Por favor, regresa el producto faltante para completar el
                      pedido.
                    </p>
                  </motion.div>
                )}
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between relative">
                  {enhancedHistory.map((step, index) => {
                    ...
                    const isCompleted =
                      index <
                      enhancedHistory.findIndex(
                        (s) => s.estadoNuevo === order.status
                      );
                    return (
                      <div
                        key={index}
        ...
        <motion.div
          ...
          whileHover={{
            scale: 1.02,
            boxShadow: '0 8px 20px rgba(252, 185, 0, 0.2)',
          }}
          transition={{ duration: 0.5 }}
        ...
        >
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
            Regístrate para gestionar tus pedidos y recibir notificaciones en
            tiempo real.
          </p>
          <motion.div
            whileHover={{ scale: 1.05 }}
