  ...
  const compromisosAdicionales = [
    {
      ...
      description:
        'Garantizamos que todos nuestros términos y condiciones sean claros, comprensibles y accesibles para nuestros clientes.',
    ...
    },
    {
      ...
      description:
        'Nos comprometemos a mantener relaciones comerciales justas y equilibradas con todos nuestros clientes.',
        ...
        >
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
            ...
            <div>
              ...
              <span className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-1 block">
                Vigente hasta: {formatDate(terminosData.fechaVigencia)} |
                Versión: {terminosData.versio || '1.0'}
              </span>
            </div>
          </div>
          ...
          >
            <p className="font-semibold text-gray-800 dark:text-gray-200">
              ...
              , establecemos relaciones claras y transparentes con nuestros
              clientes.
            </p>
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Nos esforzamos por mantener relaciones comerciales basadas en la
